...
| Identity | Custody adapter; device role; multi-device pairing | Local keystore; full; paired transfer | Machine | Restart | Exposed; presence-required |
...
ChainTorrent/
  ...
  crates/
    ...
    adapters/
      ...
      ingest-npm/
      package-host-npm/
      transport/      rqbit_overlay/  bittorrent_rqbit/   overlay onto pinned librqbit; adapter with translation, Bao post-verification, peer injection
  ...
  contracts/
    foundry.toml
    src/              Registry, ParameterSets, EnvelopeKeys, Entitlements, Locks, Escrow, Claims, Binding, VerifierKeys, PairingLib, DeliveryVerifier; each a module with its Foundry tests as its elements
