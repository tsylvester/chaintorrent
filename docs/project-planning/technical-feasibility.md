...
**Known.** No document states a date, a duration, or a deadline. The workplan states an order and the dependency map states thirty-two tickets for the harness phase with four independent starting points.
